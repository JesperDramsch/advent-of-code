...
def test_given_1():
    ...
    assert amp_chain(amps, [4, 3, 2, 1, 0])[0] == 43210
    load_all(
        amps, "3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0".split(",")
    )
    assert amp_chain(amps, [0, 1, 2, 3, 4])[0] == 54321
    load_all(
        amps,
    ...
    assert amp_chain(amps, [1, 0, 4, 3, 2])[0] == 65210
