...
def test_given_1():
    ...
    part1.load(data = {0: "R75,D30,R83,U83,L12,D49,R71,U7,L72".split(","),
    ...
    assert part1.result == 159
    assert part2.result == 610

def test_given_2():
    part1 = Day(3,1)
    part2 = Day(3,2)

    part1.load(data = {0: "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51".split(","),
    ...
    assert part1.result == 135
    assert part2.result == 410