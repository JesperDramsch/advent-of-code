...
pid:3556412378 byr:2007"""
    day.load(invalid, typing=str, process=False)
    assert main(day, part=2) == 0
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719"""
    day.load(valid, typing=str, process=False)
    assert main(day, part=2) == 4

def test_part1(day):
    assert main(day, part=1) == 256

def test_part2(day):
    assert main(day, part=2) == 198
